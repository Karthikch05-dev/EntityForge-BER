...
app = FastAPI(
    title="Business Entity Resolution Dashboard",
...
<nav class="nav"><div class="brand"><span class="logo"><svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.3"><path d="M12 3v18M3 12h18"/></svg></span>Resolve<span style="color:#778294;font-weight:500">/ intelligence</span></div><div class="status"><i class="dot"></i> ML Model Pipeline Ready</div></nav>
